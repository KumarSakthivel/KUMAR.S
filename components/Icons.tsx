...
// Fix: Complete the SVG path for MoonIcon which was truncated.
...
export const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-6 h-6" {...props}>
...
export const MicrosoftIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" className="w-5 h-5" {...props}>
...
export const PinSolidIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const MicrophoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75V18.75m0 0H9.75m2.25 0H14.25M12 18.75v3M12 3v.75m0 0v1.5m0-1.5a3 3 0 0 1 3 3v1.5a3 3 0 0 1-6 0v-1.5a3 3 0 0 1 3-3Z" />
    </svg>
);
...
export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-1.5c1.5-1.5 1.5-3.75 0-5.25S13.5 3 12 3S9 4.5 9 6.75c0 .75.3 1.5.75 2.25l.412.412M12 18h.01M12 18c.007 0 .014-.002.02-.005a2.25 2.25 0 0 1-2.27-2.245 2.25 2.25 0 0 1 2.27-2.245 2.25 2.25 0 0 1 2.27 2.245 2.25 2.25 0 0 1-2.27 2.245z" />
    </svg>
);
...
export const EnglishFlagIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" {...props}>
        ...
        <g clipPath="url(#a)">
            ...
            <path stroke="#fff" strokeWidth="4.8" d="M0 0l24 24M0 24L24 0"/>
            <path stroke="#c8102e" strokeWidth="2.88" d="M0 0l24 24M0 24L24 0"/>
            <path stroke="#fff" strokeWidth="8" d="M12 0v24M0 12h24"/>
            <path stroke="#c8102e" strokeWidth="4.8" d="M12 0v24M0 12h24"/>
        </g>
    </svg>
);

export const TamilFlagIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" {...props}>
        <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontSize="16" fontWeight="bold">த</text>
    </svg>
);

export const PausedWaveIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75v4.5m3-4.5v4.5m3-6v6m3-8.25v8.25m3-7.5v7.5m3-6v6" />
    </svg>
);